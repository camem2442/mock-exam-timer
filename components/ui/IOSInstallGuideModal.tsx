          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">공유 버튼 탭</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">홈 화면에 추가 선택</p>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">추가 완료</p>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    "추가"를 탭하여 설치를 완료하세요
                  </p>
                </div>
