                        ...
                        <tbody className="divide-y divide-border">
                            {sortBySolveOrder ? (
                                solveHistory.length > 0 ? solveHistory.map((event, index) => {
                                    ...
                                    <tr>
                                        <td colSpan={6} className="text-center p-8 text-muted-foreground text-sm">풀이 기록이 없습니다.</td>
                                    </tr>
                                )
                            ) : (
                             ...
                             {( !sortBySolveOrder && sortedQuestions.every(q => q.attempts === 0)) && (
                                <tr>
                                    <td colSpan={5} className="text-center p-8 text-muted-foreground text-sm">풀이 기록이 없습니다.</td>
                                </tr>
                             )}
                        </tbody>
                    </table>
